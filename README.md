...
**LeaderBoard projec**is A project that user can add score and name . this project is build using api
...
- [live demo link](https://fatima-najafi.github.io/Leaderboard/dist/)
...
```sh
  ...
  git clone https://github.com/fatima-najafi/Leaderboard
